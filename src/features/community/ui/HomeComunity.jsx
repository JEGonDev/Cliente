...
export const HomeComunity  = () => {
  const posts = [
    ...
    },
    {
      ...
      author: "Camila JK",
      time: "Ayer, 9:48 AM",
      content: "Comparación de calidad entre cultivos hidropónicos y tradicionales 🍅",
      likes: 3,
      comments: 2,
      hasImage: true,
      imageType: "dual",
